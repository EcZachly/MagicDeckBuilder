...
public class ImageAdapterPlaneschase extends BaseAdapter{
	...
	public ImageAdapterPlaneschase(LayoutInflater inflater, Card card, DisplayImageOptions options){		
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			view = inflater.inflate(R.layout.imagelayoutplaneschase, parent, false);
